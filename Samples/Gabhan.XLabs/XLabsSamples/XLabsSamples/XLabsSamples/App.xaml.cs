...
using XLabsSamples.Pages.Controls;
using XLabsSamples.Pages.Controls.Charts;
//using XLabsSamples.Pages.Controls.DynamicList;
using XLabsSamples.Pages.Mvvm;
using XLabsSamples.Pages.Samples;
using XLabsSamples.Pages.Services;
using XLabsSamples.ViewModel;

namespace XLabsSamples
{
